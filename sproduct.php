    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="images/f1.jpg" width="100%" id="mainimg"></div>
                ...
                <div class="single-pro-details">
                    ...
                    <Span>Dextrose (AKA glucose) is a high GI (glycemic index), fast absorbing type of 
                        simple carbohydrate. Dextrose is used by bodybuilders and athletes to induce an 
                        insulin spike and replace glycogen in muscle cells which is lost during training.</Span>
                </div>
            </div>
        </section>
