...
<html lang="en">
    ...
    <body>
        ...
        <section id="product1" class="section-p1">
            ...
            <p>Good companies are build on good products</p>
        ...
        <section id="banner" class=".section-m1">
            ...
            <h2>Get<span> Fast Relief</span> With our Range of non-prescription Meds</h2>
            <button class="normal">Explore More</button>
        </section>
        
        <section id="product1" class="section-p1">
            <h2>Offers</h2>
            <p>Save up to 20% off everything</p>
            <div class="pro-container">
                <div class="pro">
                    <img src="images/f9.jpg"alt="">
                    <div class="des">
                        <span>Silc sheer</span>
                        <h5>Neova 74ml</h5>
                        <div class="star">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
        ...
        <section id="sm-banner" class="section-p1">
            <div class="banner-box">
                ...
                <span>Grab best deal from our trusted online selling platform</span>
                <button class="white">Learn More</button>
            </div>
            <div class="banner-box banner-box2">
                <h4>Spicy</h4>
                <h2>Get exciting offers on sexual wellness items</h2>
                <span>The best classic items from pharmsquare</span>
